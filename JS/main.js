...
if (usuario) {
  ...
  if (nomeuse)
    nomeuse.innerHTML = `<strong>Bem-vindo, ${usuario.nome.split(" ")[0]}!</strong><br>Venha desbravar o Library Master!`;
}
...
document.getElementById("fecharAdd")?.addEventListener("click", () => {
...
if (document.getElementById("pesq")) {
  ...
  document
    .querySelectorAll("#tema input, #pessoais input")
    .forEach((el) => el.addEventListener("change", renderizar));
