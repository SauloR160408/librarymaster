const livrosPadrao = [
  {
    id: 1, nota: 5, todasNotas: [5], comentarios: [],
    titulo: "Harry Potter e a Pedra Filosofal", serie: true, genero: "fantasia",
    subgenero: "magia", autor: "J.K. Rowling", paginas: 264, editora: "Rocco",
    dataPublicacao: "1997", isbn: "9788532511010", tipo: "serie",
    faixaEtaria: "infantil", temas: ["magia", "aventura"],
    sobre: "Harry descobre que é um bruxo e vai para Hogwarts.",
    imagem: "imagens/harrypoter-capa.jpg", disponivel: true,
    lido: false, quero: false, lendo: false, favorito: false,
  },
  {
    id: 2, nota: 5, todasNotas: [5], comentarios: [],
    titulo: "1984", serie: false, genero: "distopia", subgenero: "politico",
    autor: "George Orwell", paginas: 328, editora: "Companhia das Letras",
    dataPublicacao: "1949", isbn: "9788535914849", tipo: "livro unico",
    faixaEtaria: "adulto", temas: ["politica", "controle"],
    sobre: "Um regime totalitário controla tudo.",
    imagem: "imagens/1984.jpg", disponivel: true,
    lido: false, quero: false, lendo: false, favorito: false,
  },
  {
    id: 3, nota: 4, todasNotas: [4], comentarios: [],
    titulo: "Drácula", serie: false, genero: "terror", subgenero: "gotico",
    autor: "Bram Stoker", paginas: 418, editora: "Penguin",
    dataPublicacao: "1897", isbn: "9780141439846", tipo: "livro unico",
    faixaEtaria: "adulto", temas: ["vampiros", "mistério"],
    sobre: "O clássico vampiro da literatura.",
    imagem: "imagens/dracula.jpg", disponivel: true,
    lido: false, quero: false, lendo: false, favorito: false,
  }
];
...
function adicionarLivro() {
  ...
  const novoLivro = {
    id: Date.now(), nota: 0, todasNotas: [], comentarios: [],
    titulo: titulo, autor: autor, serie: false,
    ...
    disponivel: true, lido: false, quero: false, lendo: false, favorito: false,
  };
